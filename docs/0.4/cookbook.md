...
> Draft placeholder — content to be written (docs #3 on the 0.4.0 launch
> checklist). Worked examples and recommended patterns go here.
...
*TODO: more recipes — recursive components, closures (0.5+), common
navigation patterns, working with datasets, etc.*
